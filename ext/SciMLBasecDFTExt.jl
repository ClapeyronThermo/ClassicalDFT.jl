module SciMLBasecDFTExt
    ...
    function SciMLBase.ODEProblem(system::ClassicalDFT.AbstractcDFTSystem, ρ, tspan, kwargs...)
    ...
    # function ClassicalDFT.converge!(system::ClassicalDFT.AbstractcDFTSystem, ρ, alg::SciMLBase.AbstractODEAlgorithm)
